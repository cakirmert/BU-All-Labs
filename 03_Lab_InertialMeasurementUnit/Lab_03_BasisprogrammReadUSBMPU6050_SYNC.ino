...
void loop()
{
  ...
  // Serial.print("Acceleration Sensor"); Serial.print("/n");
  // Serial.print("ACC X: \t"); 
  Serial.print(acc_X, DEC); Serial.print("\n");
  // Serial.print("ACC Y: \t"); 
  Serial.print(acc_Y, DEC); Serial.print("\n");
  // Serial.print("ACC Z: \t"); 
  Serial.print(acc_Z, DEC); Serial.print("\n");

  // Serial.print("Gyroskope\n");
  // Serial.print("Yaw Rate X:\t"); 
  Serial.print(gyr_X, DEC); Serial.print("\n");
  // Serial.print("Yaw Rate Y:\t"); 
  Serial.print(gyr_Y, DEC); Serial.print("\n");
  // Serial.print("Yaw Rate Z:\t"); 
  Serial.print(gyr_Z, DEC); Serial.print("\n");
  
  // Serial.print("Temperature:\n");
  //nSerial.print(temp); Serial.print("\n"); 
}
